...
let HeaderAnimation = () => {
  var c = document.getElementById('FirstSectionAnimation');
  var w = c.width = window.innerWidth,
    h = c.height = document.getElementById("template_s1").getBoundingClientRect().height,
    ctx = c.getContext( '2d' ),
...
if (document.getElementById("template_s1")) {
